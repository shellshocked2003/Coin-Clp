        ...
        case $option in
            ...
            -t|--tests)
                if [ x"$option_arg" != x ]; then
                    ...
                    echo "No argument specified with --test."
                    exit 3
                fi
                if [ $legacy_format = false ]; then
                    shift
            ...
            --fully-static)
                ...
                configure_options["--disable-bzlib"]=""
                configure_options["--disable-readline"]=""
                configure_options["--without-cholmod"]=""
                configure_options["--without-lapack"]=""
                configure_options["--without-amd"]=""
                get_third_party=false
                ;;
            -h|--help)
                help
